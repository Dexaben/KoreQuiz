...
public class ResimdenTahminScript : MonoBehaviour {
    public SceneController scenecontroller;
    public Question_resimdenTahmin[] question;
    private Question_resimdenTahmin currentquestion;
    ...
    void SetCurrentQuestion()
    {
            ...
            while (puzzletemp.Count < question.Length)
            {
                ...
                string puzzletemps = "resimdentahmin" + rand;
                if (!PlayerPrefs.HasKey("resimdentahmin" + rand))
                {
                    ...
                    PlayerPrefs.SetInt("resimdentahmin" + rand, 1);
                    return;
                }
                else
                {
